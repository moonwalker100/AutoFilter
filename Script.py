class script(object):
    START_TXT = """<blockquote expandable><b>ʜᴇʏ {}, {}\n\nI ᴀᴍ ᴛʜᴇ ᴍᴏꜱᴛ ᴘᴏᴡᴇʀꜰᴜʟ ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ ʙᴏᴛ ᴡɪᴛʜ ᴘʀᴇᴍɪᴜᴍ ꜰᴇᴀᴛᴜʀᴇꜱ, Jᴜsᴛ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴇɴᴊᴏʏ!</blockquote>\n\n‣ Mᴀɪɴᴛᴀɪɴᴇᴅ Bʏ : <a href="https://t.me/Here_remo">Ꮢᴇᴍᴏ</a></b>"""
...
❍ ʜᴏꜱᴛᴇᴅ ᴏɴ : <a href="https://t.me/loading_cluster_bots">ᴠᴘs</a>
...
ᴘᴏᴡᴇʀᴇᴅ ʙʏ - @loading_cluster_bots"""
...
ɪғ ʏᴏᴜ ғᴏᴜɴᴅ ᴀɴʏ ʙᴜɢ ɪɴ ˹Tʜɪꜱ Bᴏᴛ˼ ᴏʀ ɪғ ʏᴏᴜ ᴡᴀɴɴᴀ ɢɪᴠᴇ ғᴇᴇᴅʙᴀᴄᴋ ᴀʙᴏᴜᴛ ᴛʜᴇ ʙᴏᴛ˼, ᴩʟᴇᴀsᴇ ʀᴇᴩᴏʀᴛ ɪᴛ ᴀᴛ <a href='https://t.me/madescode_group'>sᴜᴩᴩᴏʀᴛ ᴄʜᴀᴛ</a>.</b>"""
